...
var divNo_6=document.getElementById('divNo_7');

var divNo_6=document.getElementById('divNo_8');
...
if(iAt==7)
   ...
   if(iAt==9)
     {
     divNo_8.innerHTML+="<div class=\"redbutton\">"+numberdiv+"</div>";
     divNo_8.style.display = "block";
     }
...
function checkDX_fw(n,fw_x,fw_d){
      ...
      if((!checkQJ(fw_x,num,num2))&&(!checkQJ(fw_d,num,num2))){
       alert("当大小比是"+n+":"+(9-n)+"时，范围值只能在 "+num+" -- "+num2+" 区间!");
       return true;
      }          
    return false;  
}
